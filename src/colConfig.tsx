...
const RenderRequestTypeDiv = (text: RequestType) => <div>{getEnumTextByEnum(text, EnumText.RequestType)}</div>;
...
export const columns = [
  ...
  },
  {
    ...
    test: '111',
    options: { customBodyRender: RenderRequestTypeDiv, downloadRender: RenderRequestTypeText },
  },
  {
    name: 'status',
...
export const data = [
  {
    ...
    userId: '6',
    userName: 'manager1asdasdasdasdasdasdasd',
    amount: '101asdasdasdasd',
    unit: 'JPYSasdasdasdasdasd',
    status: 1,
    withdrawalStatus: 0,
    notes: 'asdasdasdasdasdasdasdasdasdasd',
    version: '1',
    EditNote: 'asdasdasdasdasdasdasd',
  },
  {
    id: '2',
    requestType: 1,
